          ...
          <div class="code-info">
            ...
            <div class="info-right">
              <el-dropdown class="setting">
                <Icon icon="fluent:settings-24-filled" width="21" height="21" class="setting-icon"/>
                <template #dropdown>
                  <el-dropdown-menu>
...
/* 注册密钥页暗色 */
html.dark .reg-key,
html.dark .reg-key .scrollbar {
  background: #0c0f14 !important;
  color: #f2f4f8 !important;
}

html.dark .reg-key .header-actions {
  color: #f2f4f8 !important;
  box-shadow: inset 0 -1px 0 0 rgba(255, 255, 255, 0.06) !important;
  background: #12171f !important;
}

html.dark .reg-key .header-actions .icon {
  color: #e4e7ec !important;
}

html.dark .reg-key .search-input,
html.dark .reg-key .search .el-input__wrapper {
  background: #242a33 !important;
}

html.dark .reg-key .search .el-input__inner {
  color: #f2f4f8 !important;
}

html.dark .reg-key .code-item {
  background: #1a1f27 !important;
  border-color: rgba(255, 255, 255, 0.08) !important;
  color: #f2f4f8 !important;
}

html.dark .reg-key .code-item .code,
html.dark .reg-key .code-item .info-left-item,
html.dark .reg-key .code-item .info-left-item div,
html.dark .reg-key .code-item .info-left-item span {
  color: #f2f4f8 !important;
}

html.dark .reg-key .code-item .info-left-item div:first-child {
  color: #c0c5ce !important;
}

html.dark .reg-key .setting-icon,
html.dark .reg-key .info-right svg {
  color: #9aa0a8 !important;
}

html.dark .reg-key .loading {
  background: rgba(0, 0, 0, 0.4) !important;
}

html.dark .reg-key .el-empty__description p,
html.dark .reg-key .empty {
  color: #c0c5ce !important;
}

html.dark .reg-key .el-dialog,
html.dark .reg-key .history-list {
  background: #1a1f27 !important;
  color: #f2f4f8 !important;
}

html.dark .reg-key .el-dropdown-menu {
  background: #1a1f27 !important;
}

html.dark .reg-key .el-dropdown-menu__item {
  color: #f2f4f8 !important;
}

/* 其它管理列表页通用暗色卡片 */
html.dark .role .role-item,
html.dark .user .el-table,
html.dark .all-email .el-table,
html.dark .email-scroll,
