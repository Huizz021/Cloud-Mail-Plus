...
export function userForwardList() {
    return http.get('/user/forwardList')
}

export function userForwardReview(params) {
    return http.put('/user/forwardReview', params)
}

export function userForwardPendingCount() {
    return http.get('/user/forwardPendingCount')
}
