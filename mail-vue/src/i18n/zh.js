const zh = {
    ...
    uiMotion: '界面动效',
    uiMotionDesc: '全站生效。经典=原界面与过渡；iOS 弹簧=弹簧动效 + 更接近 iOS 的卡片/圆角/毛玻璃观感',
    uiMotionClassic: '经典',
    uiMotionIos: 'iOS 弹簧',
    sendEmail: '邮件发送',
    ...
    userPushSetting: '邮件推送',
    userPushSettingDesc: '仅对你收到的邮件生效。第三方邮箱需管理员审批，且地址在 Cloudflare 验证通过后才会转发；未启用时不转发。TG/Webhook 未配置时仍可回退系统设置。',
    heroUserDesc: '欢迎使用。可在「个人设置」里配置第三方邮箱 / TG / Webhook 推送。',
    userForwardHint: '未配置时不转发',
    userForwardSysHint: '未配置时走系统设置',
    tgChatId: 'chat_id',
    forwardApply: '转发审批',
    forwardApplyNone: '未申请',
    forwardApplyPending: '待审批',
    forwardApplyApproved: '已通过',
    forwardApplyRejected: '已拒绝',
    forwardApplyActive: '生效中',
    forwardApplyInactive: '未生效',
    forwardApplyDesc: '用户填写转发邮箱后需审批；请先在 Cloudflare 验证目标邮箱再通过',
    forwardReviewUser: '用户',
    forwardReviewEmail: '转发邮箱',
    forwardReviewStatus: '审批状态',
    forwardReviewActive: '生效',
    forwardReviewAction: '操作',
    forwardApprove: '通过',
    forwardReject: '拒绝',
    forwardReviewOk: '已通过，转发生效',
    forwardRejectOk: '已拒绝',
    forwardPendingNotify: '有 {count} 条邮件转发申请待审批',
    adminMonitorEmail: '管理员监控邮箱',
    adminMonitorEmailDesc: '仅在管理员自己收信且未配置个人转发时生效，不用于普通用户转发。用户转发请走「转发审批」。',
    messageCenter: '通知中心',
    systemNotice: '通知中心',
    messageInbox: '站内信',
    messageBack: '返回',
    messageFriends: '好友列表',
    messageNoChat: '选择左侧用户开始聊天',
    messageSearch: '搜索消息',
    messageDeleteConv: '删除会话',
    messageDeleteConvConfirm: '确认删除与该用户的会话记录吗？',
    messageDeleted: '会话已删除',
    forwardError: '转发失败',
    forwardErrorTip: '最近转发失败，请检查目标邮箱是否已在 Cloudflare 验证',
    cfVerified: '已验证',
    cfPending: '待验证',
    cfUnknown: 'CF中不存在',
    cfUnconfigured: '未配置CF API',
    cfConfigHint: '未配置 Cloudflare API Token（cf_api_token / cf_zone_id），请手动在 CF 后台验证后再通过审批',
    cfStatus: 'CF验证',
    messageUnread: '{count} 条未读',
    messageEmpty: '暂无消息',
    messageInputHint: '输入消息，回车发送',
    messageSendToAdmin: '发送给管理员',
    messageSelectUser: '选择用户',
    messageAdminOnly: '仅可与管理员沟通，不支持用户之间私信',
    messageSystem: '系统',
    messageFromAdmin: '管理员',
    messageMarkAllRead: '全部已读',
    messageContacts: '联系人',
    messageOpenReview: '去审批转发',
    noticeClickHint: '点击通知可查看详情；需要处理时再进入审批',
    messageFailed: '发送失败',
    messageContentEmpty: '消息不能为空',
    ...
    publishAnnouncement: '发布全站公告',
    noticePublishDesc: '发布后所有用户会收到站内信，并在进入系统时看到弹层公告',
    announcementSent: '公告已发布，已通知 {count} 位用户',
    announcementEmpty: '请先填写公告标题或内容',
    noticePopupContentHint: '仅登录/进入系统时弹出，内容与全站公告相互独立',
    announceOnlyHint: '全站公告：发布后推送站内信，并在用户下次进入时弹出一次',
    loginNoticeOnlyHint: '登录弹窗：与公告分开；开启后用户进入系统时展示此文案',
    homeHeroDescTitle: '首页文案',
    homeHeroDescHint: '收件箱顶部 Hero 区域的说明文字；留空则使用默认文案',
    noticeDocSection: '公告与文案',
    advanced: '高级设置',
    icon: '图标',
    position: '位置',
    offset: '偏移距离',
