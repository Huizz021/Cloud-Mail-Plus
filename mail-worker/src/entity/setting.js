...
export const setting = sqliteTable('setting', {
	...
	noticeVersion: integer('notice_version').default(0).notNull(),
	announceTitle: text('announce_title').default('').notNull(),
	announceContent: text('announce_content').default('').notNull(),
	announceType: text('announce_type').default('none').notNull(),
	announceVersion: integer('announce_version').default(0).notNull(),
	homeHeroDesc: text('home_hero_desc').default('').notNull(),
	...
	uiMotion: integer('ui_motion').default(0).notNull()
});
